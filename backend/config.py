...
class Config:
    ...
    WATSON_URL = os.getenv('WATSON_URL', 'https://api.us-south.watson-orchestrate.cloud.ibm.com/instances/80614aca-61af-457d-bd86-2d17121a2328')
    WATSON_API_KEY = os.getenv('WATSON_API_KEY', 'FwvIPcVFaRlpPFXoz4Kk0aar7zXZFWvDXikavjFMxMxf')
